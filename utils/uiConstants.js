...
export const services = [
  {
    ...
    procedures: [
      ...
      },
      {
        ...
        description: `<p>În Olidental Clinic, realizăm restaurări protetice care îmbină funcționalitatea cu estetica,
                      conform nevoilor pacientului.</p>
                      <p>Restaurările estetice sunt soluții protetice pe termen lung și sunt de tipul fațetelor,
                      coroanelor (dentare și protetice din porțelan, pe suport de zirconiu, dentare integral ceramice,
                      dentare zirconiu integral, acrilice și scheletate, etc), punților dentare, protezelor mobile sau
  ...
  },
  {
    ...
    procedures: [
      ...
      },
      {
        ...
        description:
          'Un zâmbet frumos trebuie să fie și unul sănătos, de aceea nu este suficient ca dinții să arate bine – aceștia trebuie să se integreze optim și să ofere confort pacientului.\
